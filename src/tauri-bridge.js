...
(function () {
  ...
  window.zapret = {
    ...
    listsOverview: () => invoke('lists_overview'),
    checkSite: (host) => invoke('check_site', { host }),
    addSite: (host, exclude) => invoke('add_site', { host, exclude: !!exclude }),
    unexcludeSite: (host) => invoke('unexclude_site', { host }),
    openListFile: (file) => invoke('open_list_file', { file }),
